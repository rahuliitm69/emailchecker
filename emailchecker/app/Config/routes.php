 ...
 */
	...
	{
		Router::connect('/', array('controller' => 'admins'));
		Router::connect('/admins', array('controller' => 'admins'));
		Router::connect('/admins/:action/*', array('controller' => 'admins','action' => ':action'));
	}else if(!empty($value)){
		Router::connect('/', array('controller' => 'users', 'action' => 'dashboard'));
		Router::connect('/:action/*', array('controller' => 'users','action' => ':action'));
	}else
	{
		Router::connect('/admins', array('controller' => 'admins','action' => 'view'));
