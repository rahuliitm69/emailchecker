...
<link href="<?php echo $this->webroot; ?>assets/admin/layout2/css/custom.css" rel="stylesheet" type="text/css"/
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<!-- BEGIN PAGE HEADER-->
				<h3 class="page-title">Modules Settings</h3>
				<div class="page-bar">
					...
					<div class="col-md-12">
						...
						<div class="portlet box red">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-cogs"></i>API Modules
								</div>
							</div>
								...
								<div class="table-scrollable">
									<table class="table table-hover">
										...
										<?php foreach($modules as $mod){ ?>
											<tr>
												<td>
													 <?php echo $mod["Module"]["id"]; ?>
												</td>
												<td>
													 <?php echo $mod["Module"]["module_name"]; ?>
												</td>
												<td>
													 <?php echo $mod["Module"]["priority_order"]; ?>
												</td>
												<td>
													<a href="javascript:void(0);" main="<?php echo $mod["Module"]["id"]; ?>" class="btn default btn-xs green edit_module">
														<i class="fa fa-edit"></i> Edit
													</a>
													<a href="javascript:void(0);" main="<?php echo $mod["Module"]["id"]; ?>" class="btn default btn-xs red delete_module">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Available API Modules
										</div>
									</div>
										...
										<!-- <form action="" class="form-horizontal"> -->
											<div class="form-body">
												...
												<div class="form-group">
													<label class="col-md-3 control-label">Quicke Mail Verification</label>
													<div class="col-md-4">
														<div class="input-group">
															<a href="<?php echo $this->webroot; ?>admins/addmodules"  class="btn btn-circle blue">Add to Modules List</a>
														</div>
													</div>
												</div>
											</div>
...
<script>
	$(document).ready(function(){
		$(".edit_module").on("click", function(){
			...
			window.location.href = "<?php echo $this->webroot ?>admins/addmodules?id="+id;
